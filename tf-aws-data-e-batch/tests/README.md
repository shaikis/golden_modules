...
- `role_arn` — from `tf-aws-iam` (null = auto-create Batch service role)
- `create_iam_role` — set `false` to bring your own service + instance + execution roles
