...
output "input_bucket_name" {
  description = "Name of the S3 input bucket (document uploads)."
...
output "output_bucket_name" {
  description = "Name of the S3 output bucket (entity results JSON)."
...
output "lambda_function_name" {
  description = "Name of the entity recognition Lambda function."
  value       = module.lambda.function_name
}

output "lambda_function_arn" {
  description = "ARN of the entity recognition Lambda function."
...
output "bedrock_guardrail_arn" {
  ...
  value       = var.enable_bedrock_guardrail ? module.bedrock.guardrail_arns["entity-extraction"] : ""
}

output "bedrock_invocation_log_prefix" {
  description = "S3 prefix where Bedrock model invocation logs are written. Empty when logging is disabled."
