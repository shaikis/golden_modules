...
- `kms_key_arn` — from `tf-aws-kms` for query result encryption (set to `null` to use SSE-S3)

```hcl
# Minimal usage
module "athena" {
  source = "git::https://github.com/your-org/tf-aws-data-e-athena.git"
  workgroups = {
    "primary" = {
