...
- `kms_key_arn` — from `tf-aws-kms` for broker encryption at rest (set to `null` for AWS-managed key)

```hcl
# Minimal usage
module "msk" {
  source = "git::https://github.com/your-org/tf-aws-data-e-msk.git"
  clusters = {
    "kafka" = {
