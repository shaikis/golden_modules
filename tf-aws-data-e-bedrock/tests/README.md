...
Bedrock Guardrail creation does not require model access; it is safe to apply in integration.
Knowledge base and agent creation require OpenSearch Serverless or another vector store to be pre-provisioned.
